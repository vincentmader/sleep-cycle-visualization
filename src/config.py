...
path_to_sleepnote_translations= os.path.join(PATH_TO_DATA, "in", "sleepnote_translations.json")
with open(path_to_sleepnote_translations) as fp:
    SLEEPNOTE_TRANSLATIONS = json.load(fp)

path_to_sleepnotes_to_skip= os.path.join(PATH_TO_DATA, "in", "sleepnotes_to_skip.json")
